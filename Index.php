...
<body class="p-5">
  ...
  <ol>
    <li>При нестрогом сравнении оператор сравнивает значение после преобразования типов</li>
    <li>При строгом сравнении оператор вернет true, только если оба операнда имеют одинаковый тип и одно и то же значение</li>
    <li>При нестрогом сравнении строки с числом приводятся к числу (int)</li>
    <li><strong>Во избежании неожиданных результатов при сравнении необходимо по возможности использовать операторы с строгим сравнением.</strong></li>
  </ol>
